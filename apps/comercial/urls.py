...
urlpatterns = [
    ...
    path('print_label_order_commodity/<int:pk>/', print_label_order_commodity, name='print_label_order_commodity'),
    ...
    path('collect_destination_payment/', login_required(collect_destination_payment), name='collect_destination_payment'),
