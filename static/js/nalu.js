...
(function ($) {
    ...
    $('.RapidoVip-nav > li').each(function () {
    ...
    $('.RapidoVip-nav > li.has-submenu').on('mouseenter', function () {

        clearTimeout(submenuTimer);

        $('.RapidoVip-nav > li.has-submenu').not(this).removeClass('submenu-open');
    ...
    function markActiveNav() {
        ...
        $('.RapidoVip-nav .submenu a, .RapidoVip-mobile-nav a[href]').each(function () {
        ...
        if (bestMatch) {
            ...
            $(bestMatch).closest('.RapidoVip-nav > li.has-submenu').addClass('is-current-section');
    ...
    var $toggle = $('#RapidoVip-menu-toggle');

    var $nav = $('#RapidoVip-mobile-nav');
